    ...
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <section className="w-full grid grid-cols-1 gap-5 @min-[640px]/main:grid-cols-2 @min-[1024px]/main:grid-cols-3 @min-[1280px]/main:grid-cols-4">
        {stats.isSuccess && (
          ...
          >
            <DropdownMenuItem>
              <Link href={"/tableau-de-bord/conges"}>
                {"Gérer les demandes"}
              </Link>
            </DropdownMenuItem>
          </StatisticCard>
        ...
        {employees.isSuccess && (
          ...
          >
            <DropdownMenuItem>
              <Link href={"/tableau-de-bord/employes"}>
        ...
        {userHolidays.isSuccess && (
          <StatisticCard
            ...
            value={userHolidays.data.remainingDays}
            variant={"default"}
            advanced={{ title: "Année", value: userHolidays.data.year }}
          >
            <DropdownMenuItem>
        ...
        {user?.role !== "USER" && (
          <StatisticCard
            ...
            value={487}
            advanced={{ title: "Dernier bulletin", value: "Août" }}
          >
            <DropdownMenuItem>
        ...
        {user?.role === "USER" && userHolidays.isSuccess && (
          <StatisticCard
            ...
            value={userHolidays.data.usedDays}
        ...
        {user?.role === "USER" && (
          <StatisticCard
            ...
            advanced={{ value: "13 Bulletins" }}
          >
            <DropdownMenuItem>
              <Link href={"/tableau-de-bord/mes-bulletins"}>
      ...
      <section className="grid grid-cols-1 gap-4 @min-[640px]/main:gap-6 @min-[960px]/main:grid-cols-3">
        ...
        <div className="@container col-span-1 @min-[960px]/main:col-span-2 card-1">
          <div className="card-1-header">
            <h3 className="flex items-center gap-2">
              <span className="card-1-icon bg-primary-500">
                <HugeiconsIcon
          ...
          <div className="w-full grid grid-cols-1 gap-2 @min-[260px]:grid-cols-2 @min-[340px]:grid-cols-3 @min-[460px]:grid-cols-4 @min-[578px]:grid-cols-5 @min-[760px]:grid-cols-6">
            ...
            <Link
              href={"/tableau-de-bord/mes-conges/creer"}
              className="quick-container"
            >
              <button className="quick-action">
        ...
        {/**Quick links END */}
        <div className="card-1 bg-accent relative overflow-clip">
          <div className="card-1-header z-1">
            <h3 className="text-white flex items-center gap-2">
              <span className="card-1-icon bg-white text-accent">
                <HugeiconsIcon
        ...
        <div className="card-1">
          ...
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                {"Vous n'avez pas de notification enregistrée."}
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        </div>
          ...
          <div className="card-1 @min-[960px]/main:col-span-2">
            ...
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  {"Vous n'avez pas encore d'historique de présence."}
                </EmptyDescription>
              </EmptyHeader>
            </Empty>
          </div>
          ...
          <div className="card-1 @min-[960px]/main:col-span-2">
            ...
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  {"Vous n'avez pas de demande d'absence en attente."}
                </EmptyDescription>
              </EmptyHeader>
            </Empty>
          </div>
