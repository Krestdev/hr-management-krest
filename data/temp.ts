...
export const demoUsers: Array<Employee> = [
  {
    ...
    role: "SUPER_ADMIN",
    gender: "MALE",
    birthday: new Date("1990-05-12").toISOString().split("T")[0],
    nationality: "Cameroun",
    countryOfResidence: "Cameroun",
    address: "Douala - Akwa",
    phoneNumber: "+237650000000",
    matrimonial_status: 0,
    number_of_children: 0,
    EmergencyContactPhone: "+237699999999",
    CNPSNumber: "CNPS123456",
    idDocumentType: "CNI",
    idDocumentNumber: "123456789",
    idDocumentIssueDate: new Date("2015-06-01"),
    idDocumentExpiryDate: new Date("2030-06-01"),
    idDocumentIssuePlace: "Douala",
  ...
  },
  {
    ...
    phoneNumber: "+237690111222",
    matrimonial_status: 1,
    number_of_children: 2,
    EmergencyContactPhone: "+237699888777",
    idDocumentType: "CNI",
    idDocumentNumber: "987654321",
    idDocumentIssueDate: new Date("2017-08-10"),
    idDocumentExpiryDate: new Date("2032-08-10"),
    idDocumentIssuePlace: "Yaoundé",
    position: ["Comptable"],
    department: ["Finance"],
    supervisorId: "2",
    category: "VIII",
  ...
  },
  {
    ...
    role: "ADMIN",
    gender: "FEMALE",
    birthday: new Date("1992-04-21").toISOString().split("T")[0],
    nationality: "Cameroun",
    countryOfResidence: "Cameroun",
    address: "Douala - Bonamoussadi",
    phoneNumber: "+237694604886",
    matrimonial_status: 1,
    number_of_children: 3,
    EmergencyContactPhone: "+237699888777",
    idDocumentType: "CNI",
    idDocumentNumber: "983014321",
    idDocumentIssueDate: new Date("2016-06-11"),
    idDocumentExpiryDate: new Date("2026-06-12"),
    idDocumentIssuePlace: "Douala",
...
export const presencesData: Presence[] = [
  ...
  },
  {
    uuid: "2",
    employeeId: "1",
    checkIn: "2026-02-16T00:00:00.000Z",
    status: ["LATE"],
